...
$show_form = FALSE;
	...
	$token = ($_GET['t']);
	$query = "SELECT custId FROM tbl_customers WHERE emailVerificationCode = '$token' AND emailVerificationCode!=''";
	...
	{
		$query = "UPDATE tbl_customers SET emailVerified='1',emailVerificationCode='' WHERE custId = $custId";
