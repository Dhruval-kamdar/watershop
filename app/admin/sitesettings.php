<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "")
    {
		...
		if ($FromEmail == "" || $LoginEmail == "")
        {
			...
			if ($LoginEmail == "")
            {
				$errormessage = "Please enter Admin E-mail العنوان ";
			}
			if ($FromEmail == "")
            {
				$errormessage = "Please enter From E-mail العنوان ";
			}
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
        ...
        <title><?php  echo "Site Settings - ".SITE_NAME; ?></title>
            ...
            <div id="wrapper">     
                ...
                <div id="content">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="dashboard.php" class="glyphicons" title="الصفحة الرئيسية"><i class="icon-home"></i>الصفحة الرئيسية</a></li>
                        <li class="divider"></li>
                        <li>إعدادات الموقع</li>
					</ul>
                    <!-- // Breadcrumb END -->
                    <h3 class="heading-mosaic">إعدادات الموقع</h3>
                    <div class="innerLR">
                        <?php
								...
								<div class="widget-body">
									...
									<form  class="form-horizontal" name="emailsetting" class="emailsetting" id="emailsetting" action="<?php echo $pageurl; ?>" method="post">
										<div class="row-fluid">
											<div class="span8 top15">
												<div class="control-group">
													<label class="control-label" for="fromemailadd">From E-mail العنوان&nbsp;:&nbsp;</label>
												...
												<div class="control-group">
													<label class="control-label" for="adminemailadd">Admin E-mail العنوان&nbsp;:&nbsp;</label>
												...
												<div class="control-group">
													<label class="control-label" for="CcEmail">Cc E-mail العنوان&nbsp;:&nbsp;</label>
										...
										<div class="form-actions">
											<span class="span2"><button type="submit" value="submit" name="save" id="save" class="btn btn-block btn-primary" title="تحديث">تحديث</button></span>
										</div>
									</form>
									<!-- // Table END -->
								</div>
						...
						<!-- Form actions -->
						<!--<div class="form-actions">
							<span class="span2"><button type="submit" value="submit" name="save1" id="save1" class="btn btn-block btn-primary" title="تحديث">تحديث</button></span>
							</div>
							</form>
						<!-- // Table END -->
						<!--</div>
