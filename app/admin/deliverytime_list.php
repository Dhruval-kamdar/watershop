        ...
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">موعد التسليم<small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="add_deliverytime.php" class="btn btn-icon btn-primary glyphicons" title="إضافة وقت"><i class="icon-plus-sign"></i>إضافة وقت</a></span>
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="dashboard.php"><i class="fa fa-home"></i></a></li>
						<li><a href="deliverytime_list.php">موعد التسليم</a></li>
