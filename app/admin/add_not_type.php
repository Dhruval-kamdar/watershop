<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "")
    {
        ...
        {
			$error1 = "1";
			$errormessage1 = "Please enter type title (app)";
		}
		...
		else
        {
			...
			// $Sitelogo2 = $_FILES['Offerصورة']['name'];
			// $Sitelogo3 = $_FILES['Movieصورة3']['name'];
			//$hdn_image = $_POST['hdn_image'];
			function Processedصورة($notTypeIcon,$fieldname)
			{
			...
			$hdn_image = $_POST['hdn_image'];
			$notTypeIcon = Processedصورة($profileimage,"notTypeIcon");
			
			
			//$SiteLogo = Processedصورة($Sitelogo,"teamid");
			//$car_image = Processedصورة($Sitelogo2,"car_image");
			// $SiteLogo3 = Processedصورة($Sitelogo3,"Movieصورة3");
...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
		...
		<title><?php
			if ($id)
			{
				echo "تحرير النوع - ".SITE_NAME;
			}
			else
			{
				echo "إضافة نوع - ".SITE_NAME;
			}
		?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"إضافة":"تصحيح";?> نوع إعلام <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="not_type_list.php" class="btn btn-icon btn-primary glyphicons" title="View Types"><i class="icon-plus-sign"></i>عرض أنواع</a></span>
					<!-- Begin breadcrumb -->
					...
					<div class="the-box">
						<form  id="addType" class="form-horizontal" enctype="multipart/form-data" name="addType"  action="<?php echo $pageurl; ?>" method="post">
                                ...
                                <div class="form-group">
									<label class="col-lg-3 control-label">عنوان العرض:</label>
									<div class="col-lg-5">
										<input type="text" class="form-control" name="notTypeTitle" value="<?php echo (isset($notTypeTitle) ? $notTypeTitle : ""); ?>" placeholder="الخصم,Free delivery,Reduced,Issue etc" required />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">وصف قصير:</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
								<label class="col-lg-3 control-label" for="notTypeIcon">أيقونة:</label>
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
												...
												<img src="../uploads/icons/<?php echo $notTypeIcon; ?>" alt="صورة المعاينة" height="30px" width="30px" style="border-radius:5px" />
								...
								<div class="col-lg-9 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'not_type_list.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="إلغاء">إلغاء</button></span>
								</div>
								</div>
