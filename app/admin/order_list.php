			...
			<div class="page-content">
				<div class="container-fluid">
					...
					<ol class="breadcrumb default square rsaquo sm">
						...
						<li><a href="order_list.php">الطلبات</a></li>
						<li class="active">عرض</li>
						
					</ol>
					<div class="has-feedback">
						<form action="order_export.php?orderType=regular" method="post">
					...
					else
					{
					 ...
					 // array to string conversion 
						$.ajax({
							...
							data: {startDate:startDate,endDate:endDate,orderType:"regular",opt:opt},
