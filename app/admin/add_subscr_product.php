...
<div class="col-lg-8">
	<label class="col-lg-2 control-label"><img src ="../uploads/products/320/<?=$row['prdصورة']?>" height="50px" width ="50px"/></label>
	...
	<input type="hidden" name="prdصورة[]" value="<?php echo $row['prdصورة']; ?>" />
