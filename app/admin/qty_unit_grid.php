...
$query=mysqli_query($conn, $sql) or die("qty_unit_grid.php: get employees");
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = "<div class='btn-group'>
											  ...
											  <ul class='dropdown-menu primary' role='menu'>
												<li><a onclick=updateStatus('".$row["qtyUnitId"]."','active') >نشط</a></li>
												<li><a onclick=updateStatus('".$row["qtyUnitId"]."','deactive') >غير نشط</a></li>
											  </ul>
											</div>";
	...
	<a data-id="'.$row["qtyUnitId"].'" class="btnDelete btn btn-xs btn-danger" >حذف</a>';
