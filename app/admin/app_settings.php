		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading">إعداد التطبيق<small></small></h1>
					<!-- End page heading -->
					...
					<ol class="breadcrumb default square rsaquo sm">
						...
						<li class="active">إعداد التطبيق</a></li>
					</ol>
					<!-- End breadcrumb -->
						...
						<form  id="addFrm" class="form-horizontal" enctype="multipart/form-data" name="addFrm"  action="<?php echo $pageurl; ?>" method="post">
							<fieldset>
                                ...
                                <div class="form-group">
									...
									<option value="flat" <?php if($objsel["description"]=='flat') { ?> selected <?php } ?>>مسطحة</option>
									<option value="percent" <?php if($objsel["description"]=='percent') { ?> selected <?php } ?> >نسبه مئويه</option>
									</select>
