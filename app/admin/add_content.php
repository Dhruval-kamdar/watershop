<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "") 
    {
		...
		else
        {
			...
			$cancelurl = $urladd;
			function Processedصورة($que_pic,$fieldname)
			{
			...
			//$que_pic = Processedصورة($profileimage,"que_pic");
...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
		...
		<title><?php
			if ($id)
			{
				echo "تعديل Content :: Admin :: ".SITE_NAME;
			}
			else
			{
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"":"";?> الشروط و الأحكام <small></small></h1>
					<!-- End page heading -->
					<!--<span class="pull-right" ><a href="content_list.php" class="btn btn-icon btn-primary glyphicons" title="View الشروط و الأحكام"><i class="icon-plus-sign"></i>View الشروط و الأحكام</a></span>-->
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="dashboard.php"><i class="fa fa-home"></i></a></li>
						<li><a href="add_content.php">الشروط و الأحكام</a></li>
					...
					<?php if($error!="" || $error1!=""){ 
							...
							if (isset($_GET["suc"]) && $_GET["suc"] != "")
                            {
								...
								$success = $converter->decode($_GET["suc"]);
									if ($success == 1)
                                {
									echo '<script> getMessage("success","'.str_replace("{modulename}", "محتوى", $lang["updatemessage-status"]).'"); </script>';
								}
								elseif ($success == 2)
                                {
									
									echo '<script> getMessage("error","'.str_replace("{modulename}", "محتوى", $lang["deletemodulemessage"]).'"); </script>';
								}
								elseif ($success == 3)
                                {
								...
								elseif ($success == 4)
                                {
									...
									echo '<script> getMessage("success","'.str_replace("{modulename}", "محتوى", $lang["addmodulemessage"]).'"); </script>';
								}
								elseif ($success == 5)
                                {
									
									echo '<script> getMessage("success","'.str_replace("{modulename}", "محتوى", $lang["updatemodulemessage"]).'"); </script>';
								}
						...
						<form  id="addForm1" class="form-horizontal" enctype="multipart/form-data" name="addForm"  action="<?php echo $pageurl; ?>" method="post">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-lg-1 control-label">العنوان:</label>
									<div class="col-lg-10">
								...
								<div class="form-group">
									<label class="col-lg-1 control-label">التفاصيل:</label>
									<div class="col-lg-10">
								...
								<div class="col-lg-10 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'add_content.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="إلغاء">إلغاء</button></span>
								</div>
								</div>
