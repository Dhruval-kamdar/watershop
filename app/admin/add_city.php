...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head>
		...
		<title><?php
			if ($id)
			{
				echo "تعديل مدينة :: Admin :: ".SITE_NAME;
			}
			else
			{
				echo "أضف مدينة :: Admin :: ".SITE_NAME;
			}
		?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"إضافة":"تصحيح";?> مدينة <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="city_list.php" class="btn btn-icon btn-primary glyphicons" title="عرض المدن"><i class="icon-plus-sign"></i>عرض المدن</a></span>
					<!-- Begin breadcrumb -->
						...
						<form  id="addCity" class="form-horizontal" enctype="multipart/form-data" name="addCity"  action="<?php echo $pageurl; ?>" method="post">
							<fieldset>
                                <div class="form-group">
									<label class="col-lg-3 control-label">رمز المدينة:</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">اسم المدينة:</label>
									<div class="col-lg-5">
								...
								<div class="col-lg-9 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'city_list.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="إلغاء">إلغاء</button></span>
								</div>
								</div>
							</fieldset>
