...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head>
		...
		<title><?php echo "فئة المنتج - ".SITE_NAME;	?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading">فئة المنتج <small></small></h1>
					<!-- End page heading -->
					...
					<ol class="breadcrumb default square rsaquo sm">
						...
						<li class="active">فئة المنتج</a></li>
					</ol>
					<!-- End breadcrumb -->
						...
						<form  id="changepassword" class="form-horizontal" enctype="multipart/form-data" name="changepassword"  action="<?php echo $pageurl; ?>" method="post">
							<fieldset>
                                <div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 1:</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 2:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_2" value="<?=$id_2?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 3:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_3" value="<?=$id_3?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 4:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_4" value="<?=$id_4?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 5:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_5" value="<?=$id_5?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 6:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_6" value="<?=$id_6?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 7:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_7" value="<?=$id_7?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 8:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_8" value="<?=$id_8?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 9:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_9" value="<?=$id_9?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">فئة المنتج 10:</label>
									<div class="col-lg-5">
										<input class="form-control" id="currentpassword" name="id_10" value="<?=$id_10?>" type="text" maxlength="16"  />
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
