<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "")
    {
        ...
        {
			$error1 = "1";
			$errormessage1 = "Please enter company email"; 
		}
...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
		...
		<title><?php
			if ($id)
			{
				echo "تحرير الشركة - ".SITE_NAME;
			}
			else
			{
				echo "إضافة شركة - ".SITE_NAME;
			}
		?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"إضافة":"تصحيح";?> الشركة <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="company_list.php" class="btn btn-icon btn-primary glyphicons" title="عرض الشركات"><i class="icon-plus-sign"></i>عرض الشركات</a></span>
					<!-- Begin breadcrumb -->
					...
					<div class="the-box">
						<form  id="addUser" class="form-horizontal" enctype="multipart/form-data" name="addUser"  action="<?php echo $pageurl; ?>" method="post">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">عنوان الشركة:</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">الموقع الإلكتروني:</label>
									<div class="col-lg-5">
										<input type="website" class="form-control" name="companyWebsite" value="<?php echo (isset($companyWebsite) ? $companyWebsite : ""); ?>"  />
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-3 control-label">التواصل مع أحد أفراد الشركة:</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">ملاحظات إضافية:</label>
									<div class="col-lg-5">
								...
								<div class="col-lg-9 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'company_list.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="إلغاء">إلغاء</button></span>
								</div>
								</div>
