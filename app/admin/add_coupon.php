<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "")
    {
        ...
        {
			$error1 = "1";
			$errormessage1 = "Coupon code already exist";
		}
...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
		...
		<title><?php
			if ($id)
			{
				echo "تحرير القسيمة :: Admin :: ".SITE_NAME;
			}
			else
			{
				echo "إضافة كوبون :: Admin :: ".SITE_NAME;
			}
		?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"إضافة":"تصحيح";?> كوبون <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="coupon_list.php" class="btn btn-icon btn-primary glyphicons" title="عرض الكوبونات"><i class="icon-plus-sign"></i>عرض الكوبونات</a></span>
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="dashboard.php"><i class="fa fa-home"></i></a></li>
						<li><a href="coupon_list.php">كوبون</a></li>
						...
						<form  id="addUser" class="form-horizontal" enctype="multipart/form-data" name="addUser"  action="<?php echo $pageurl; ?>" method="post">
							<fieldset>
                                <div class="form-group">
									<label class="col-lg-3 control-label">رمز الكوبون:</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">وقت البداية:</label>
									<div class="col-lg-3">
								...
								<div class="form-group">
									...
									<div class="col-lg-2">
										...
										<option value="flat" <?=($discountType=='flat')?'selected':''?>>مسطحة</option>
										<option value="percent" <?=($discountType=='percent')?'selected':''?>>النسبة المئوية</option>
										</select>
									</div>
									<span class="errorstar">&nbsp;*</span>
								</div>
								<div class="form-group">
									<label class="col-lg-3 control-label">الحد الأدنى للطلب:</label>
									<div class="col-lg-5">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">متعدد الاستخدام:</label>
									<div class="col-lg-5">
								...
								<div class="col-lg-9 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'coupon_list.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="إلغاء">إلغاء</button></span>
								</div>
								</div>
