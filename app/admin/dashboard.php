<?php
	...
	//$Query = "SELECT * FROM `tbl_customer_jobs` WHERE tbl_customer_jobs.deleted='0'  ORDER BY created DESC LIMIT 5";
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head>
        ...
        <title><?php  echo "الصفحة الرئيسية - ".SITE_NAME; ?></title>
        ...
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">الصفحة الرئيسية <small></small></h1>
					<!-- End page heading -->
	...
	<!--Code for POPUP Dialog Box-->
		...
		<script> getMessage("loggedin","تسجيل الدخول بنجاح"); </script>
