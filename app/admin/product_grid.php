...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = '<a class="ViewDialog btn btn-xs btn-success" data-id="'.$converter->encode($row["prdId"]).'" href="#viewModel" data-toggle="modal"><i class="icon-trash icon-white"></i>عرض</a>
	<a href="'.$editurl.'" title="تصحيح" ><button class="btn btn-xs btn-success">تعديل</button></a>'.$delButton;
	$data[] = $nestedData;
	$i++;
}
$json_data = array(
