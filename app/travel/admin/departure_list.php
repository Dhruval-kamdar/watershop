<?php
	...
	$pagename   = "departure_list";
	$pageurl    = "departure_list.php";
?>
<!DOCTYPE html>
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
        ...
        <title><?php  echo "View Departure :: Admin :: ".SITE_NAME; ?></title>
        ...
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">View Departure <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="add_departure.php" class="btn btn-icon btn-primary glyphicons" title="Add Departure"><i class="icon-plus-sign"></i>Add Departure</a></span>
					<!-- Begin breadcrumb -->
					...
					<?php
							if (isset($_GET["suc"]) && $_GET["suc"] != "")
                            {
								...
								if ($success == 1)
                                {
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Departure", $lang["updatemessage-status"]).'"); </script>';
								}
								elseif ($success == 2)
                                {
									
									echo '<script> getMessage("error","'.str_replace("{modulename}", "Departure", $lang["deletemodulemessage"]).'"); </script>';
								}
								elseif ($success == 3)
                                {
								...
								elseif ($success == 4)
                                {
									...
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Departure", $lang["addmodulemessage"]).'"); </script>';
								}
								elseif ($success == 5)
                                {
									
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Departure", $lang["updatemodulemessage"]).'"); </script>';
								}
							}
						?>
					<!-- BEGIN DATA TABLE -->
	...
	<!-- Modal -->
		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <div class="modal-header">
				...
				<h3 class="modal-title" id="viewModel">Departure Info</h3>
			  </div>
		...
		<!-- Modal End -->
		<script>
		var gridUrl = "departure_grid.php";
		var viewUrl = "departure_view.php";
		var actionUrl = "departure_action.php";
