		...
		<div class="form-group">
			<label class="col-lg-3 control-label-text">Customer#:</label>
			<div class="col-lg-6">
		...
		<div class="form-group">
			<label class="col-lg-3 control-label-text">Gender:</label>
			<div class="col-lg-6">
			<?php echo $objsel['gender'];?>
			</div>
		</div>
		
		<div class="form-group">
			<label class="col-lg-3 control-label-text">Email-id:</label>
			<div class="col-lg-6">
