<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "")
    {
        ...
        {
			$error1 = "1";
			$errormessage1 = "Please select end time";
		}
...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head>
		...
		<title><?php
			if ($id)
			{
				echo "Edit Delivery Time :: Admin :: ".SITE_NAME;
			}
			else
			{
				echo "Add Delivery Time :: Admin :: ".SITE_NAME;
			}
		?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"Add":"Edit";?> Delivery Time <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="deliverytime_list.php" class="btn btn-icon btn-primary glyphicons" title="View Delivery Times"><i class="icon-plus-sign"></i>View Delivery Times</a></span>
					<!-- Begin breadcrumb -->
							...
							<fieldset>
								...
								<div class="col-lg-9 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'deliverytime_list.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="Cancel">Cancel</button></span>
								</div>
								</div>
							</fieldset>
