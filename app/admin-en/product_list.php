...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
        ...
        <title><?php  echo "View Product(s) :: Admin :: ".SITE_NAME; ?></title>
        ...
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">View Product(s) <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="add_product.php" class="btn btn-icon btn-primary glyphicons" title="Add Product"><i class="icon-plus-sign"></i>Add Product</a></span>
					<!-- Begin breadcrumb -->
		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <div class="modal-header">
				...
				<h3 class="modal-title" id="viewModel">Product Info</h3>
			  </div>
