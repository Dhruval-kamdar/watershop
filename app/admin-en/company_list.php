...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
        ...
        <title><?php  echo "View Companies :: Admin :: ".SITE_NAME; ?></title>
        ...
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">View Companies <small></small></h1>
					
					<span class="pull-right" ><a href="add_company.php" class="btn btn-icon btn-primary glyphicons" title="Add Company"><i class="icon-plus-sign"></i>Add Company</a></span>
					<!-- End page heading -->
