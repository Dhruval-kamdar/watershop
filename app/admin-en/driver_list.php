...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
        ...
        <title><?php  echo "View Driver(s) :: Admin :: ".SITE_NAME; ?></title>
    ...
    <body onLoad="document.getElementById('st').focus();">
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">View Driver(s) <small></small></h1>
					
					<span class="pull-right" ><a href="add_driver.php" class="btn btn-icon btn-primary glyphicons" title="Add Driver"><i class="icon-plus-sign"></i>Add Driver</a></span>
					<!-- End page heading -->
					...
					<?php
							if (isset($_GET["suc"]) && $_GET["suc"] != "")
                            {
								...
								if ($success == 1)
                                {
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Driver", $lang["updatemessage-status"]).'"); </script>';
								}
								elseif ($success == 2)
                                {
									
									echo '<script> getMessage("error","'.str_replace("{modulename}", "Driver", $lang["deletemodulemessage"]).'"); </script>';
								}
								elseif ($success == 3)
                                {
								...
								elseif ($success == 4)
                                {
									...
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Driver", $lang["addmodulemessage"]).'"); </script>';
								}
								elseif ($success == 5)
                                {
									
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Driver", $lang["updatemodulemessage"]).'"); </script>';
								}
		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <div class="modal-header">
				...
				<h3 class="modal-title" id="viewModel">Driver Info</h3>
			  </div>
		...
		<script>
			var gridUrl = "driver_grid.php";
			var viewUrl = "driver_view.php";
			var actionUrl = "driver_action.php";
			var targetsCols = [0,5,6,7];
			var orderCols = [[1,"asc"]];
		</script>
