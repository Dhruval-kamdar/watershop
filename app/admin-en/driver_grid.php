...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = '<a class="ViewDialog btn btn-xs btn-success" data-id="'.$converter->encode($row["driverId"]).'" href="#viewModel" data-toggle="modal"><i class="icon-trash icon-white"></i> View</a>
