<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "")
    {
        ...
        {
			$error1 = "1";
			$errormessage1 = "Please enter Product Name";
		}
		elseif ($prdTypeId == "")
        {
			$error1 = "1";
			...
			function ProcessedImage($prdImage,$fieldname)
			{
				...
				if ($prdImage != "")
				{
					if ($generalFunction->validAttachment($prdImage))
					{
						...
						$prdImage = $new_filename . time() . "." . $ext1;
...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
		...
		<title><?php
			if ($id)
			{
				echo "Edit Product :: Admin :: ".SITE_NAME;
			}
			else
			{
				echo "Add Product :: Admin :: ".SITE_NAME;
			}
		?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"Add":"Edit";?> Product <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="product_list.php" class="btn btn-icon btn-primary glyphicons" title="View Products"><i class="icon-plus-sign"></i>View Products</a></span>
					<!-- Begin breadcrumb -->
					...
					<div class="the-box">
						<form  id="addProduct" class="form-horizontal" enctype="multipart/form-data" name="addProduct"  action="<?php echo $pageurl; ?>" method="post">
									...
									<div class="col-lg-5">
										<select class="form-control" name="prdTypeId" required>
											...
											<?php
												...
												$dbfunction1->SimpleSelectQuery("SELECT prdTypeId,prdType FROM tbl_product_types WHERE isActive='1' AND isDeleted='0' ORDER BY prdType");
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">Product Company:</label>
									<div class="col-lg-5">
								...
								<?php
									$i=0;
									$dbfunction1 = new dbfunctions();
									$dbfunction1->SimpleSelectQuery("SELECT * FROM tbl_qty_units WHERE isActive='1' AND isDeleted='0'");
									while ($objsel1 = $dbfunction1->getFetchArray())
                                    {
								...
								<div class="form-group">
								<label class="col-lg-3 control-label" for="prdImage">Image:</label>
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
												...
												<img src="../uploads/products/320/<?php echo $prdImage; ?>" alt="Preview Image" height="100px" width="100px" style="border-radius:5px" />
								...
								<div class="col-lg-9 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'product_list.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="Cancel">Cancel</button></span>
								</div>
								</div>
