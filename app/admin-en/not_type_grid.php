...
//$conn = mysql_connect(DBSERVER, DBUSERNAME, DBPASSWORD) or die("Connection failed: ");
...
while( $row=mysql_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = '<a class="ViewDialog btn btn-xs btn-success" data-id="'.$converter->encode($row["notTypeId"]).'" href="#viewModel" data-toggle="modal"><i class="icon-trash icon-white"></i> View</a>
