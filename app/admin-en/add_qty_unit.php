...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head>
		...
		<title><?php
			if ($id)
			{
				echo "Edit Qty Unit :: Admin :: ".SITE_NAME;
			}
			else
			{
				echo "Add Qty Unit :: Admin :: ".SITE_NAME;
			}
		?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"Add":"Edit";?> Qty Unit <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="qty_unit_list.php" class="btn btn-icon btn-primary glyphicons" title="View Units"><i class="icon-plus-sign"></i>View Units</a></span>
					<!-- Begin breadcrumb -->
					...
					<div class="the-box">
						<form  id="addQty Unit" class="form-horizontal" enctype="multipart/form-data" name="addQty Unit"  action="<?php echo $pageurl; ?>" method="post">
							<fieldset>
                                <div class="form-group">
									<label class="col-lg-3 control-label">Qty Unit:</label>
									<div class="col-lg-5">
								...
								<div class="col-lg-9 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'qty_unit_list.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="Cancel">Cancel</button></span>
								</div>
								</div>
							</fieldset>
