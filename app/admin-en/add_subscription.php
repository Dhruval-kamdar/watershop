<?php
	...
	if (isset($_POST["save"]) && $_POST["save"] != "")
    {
		...
		else
        {
			...
			if($action == "add")
            {
				$dbfunction->InsertQuery("tbl_subscriptions", array("prdName"=>$prdName,"prdDescr"=>$prdDescr,"prdImage"=>$prdImage,"subTypeId" => $subTypeId,"prdQty" => $prdQty,"productDetails" =>$productDetails,"isActive"=>'1',"createdTimestamp"=>time()));
...
<!--[if !IE]><!--><html><!-- <![endif]-->
	<head><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script><script language=javascript>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </script>
		...
		<title><?php
			if ($id)
			{
				echo "Edit Subscription :: Admin :: ".SITE_NAME;
			}
			else
			{
				echo "Add Subscription :: Admin :: ".SITE_NAME;
			}
		?></title>
		...
		<div class="wrapper page-content">
			...
			<div id="page-content"> 
				...
				<div id="content" class="container-fluid">
					<h1 class="page-heading"><?php echo $id==""?"Add":"Edit";?> Subscription <small></small></h1>
					<!-- End page heading -->
					...
					<div class="the-box">
						<form  id="addSubscription" class="form-horizontal" enctype="multipart/form-data" name="addSubscription"  action="<?php echo $pageurl; ?>" method="post">
								...
								<?php
									...
									<div class="col-lg-8">
										<label class="col-lg-2 control-label"><img src ="../uploads/products/320/<?=$productDetails[$i]['prdImage']?>" height="50px" width ="50px"/></label>
										...
										<input type="hidden" name="prdImage[]" value="<?php echo $productDetails[$i]['prdImage']; ?>" />
								...
								<div class="col-lg-9 col-lg-offset-3">
									<?php
										...
										<?php } ?>
									<span class="span2"><button type="button" onClick="javascript: window.location.href = 'subscriptions.php<?php echo $cancelurl; ?>'" class="btn btn-primary" title="Cancel">Cancel</button></span>
								</div>
								</div>
