...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head>
        ...
        <title><?php  echo "View Units :: Admin :: ".SITE_NAME; ?></title>
        ...
        <div class="container-fluid fluid menu-left">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">View Units <small></small></h1>
					<!-- End page heading -->
					<span class="pull-right" ><a href="add_qty_unit.php" class="btn btn-icon btn-primary glyphicons" title="Add Qty Unit"><i class="icon-plus-sign"></i>Add Qty Unit</a></span>
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="dashboard.php"><i class="fa fa-home"></i></a></li>
						<li><a href="qty_unit_list.php">Qty Unit</a></li>
					...
					<?php
							if (isset($_GET["suc"]) && $_GET["suc"] != "")
                            {
								...
								if ($success == 1)
                                {
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Qty Unit", $lang["updatemessage-status"]).'"); </script>';
								}
								elseif ($success == 2)
                                {
									
									echo '<script> getMessage("error","'.str_replace("{modulename}", "Qty Unit", $lang["deletemodulemessage"]).'"); </script>';
								}
								elseif ($success == 3)
                                {
								...
								elseif ($success == 4)
                                {
									...
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Qty Unit", $lang["addmodulemessage"]).'"); </script>';
								}
								elseif ($success == 5)
                                {
									
									echo '<script> getMessage("success","'.str_replace("{modulename}", "Qty Unit", $lang["updatemodulemessage"]).'"); </script>';
								}
							}
						?>
					<!-- BEGIN DATA TABLE -->
		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <div class="modal-header">
				...
				<h3 class="modal-title" id="viewModel">Qty Unit Info</h3>
			  </div>
