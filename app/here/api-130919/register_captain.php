...
$d=array();	
	...
	if($err!='')
	{
		...
		if(!empty($rows))
		{
			...
			$jsonArray['Success']='1';
			$jsonArray['Message']=$lang["REVIEW_YOUR_DOCUMENTS"];
			$jsonArray['Message']= "Thank you! We will review your documents and get back to you.";		
		}
		else
		{
			$jsonArray['Success']='0';
			$jsonArray['Message']=$lang["UNAUTHORIZED_ACCESSS"];
			$jsonArray['Message']="Invalid Access.";
		}
		show_output($jsonArray); 
