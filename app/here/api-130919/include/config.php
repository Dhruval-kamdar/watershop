...
error_reporting(0);
define("BASE_URL_API", "http://watershopapp.com/app/here/api/");
define("BASE_URL", "http://watershopapp.com/app/here/");
define("PHOTO_URL", BASE_URL."uploads/");
define("NOTIFICATION_ICON", PHOTO_URL."icons/");
/** DATABASE CONFIGURATION **/
define("DB_HOST", "localhost");
define("DB_USER", "qataf123_here_us");
define("DB_PASS", "here#531!@!");
define("DB_NAME", "qataf123_here_app");
...
{
	return $result = sms_bulksms($phone_number,$message_data);
}
